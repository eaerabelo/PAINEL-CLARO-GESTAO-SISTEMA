                        ...
                        <thead className="text-[11px] text-white uppercase bg-[#C00000] sticky top-0 z-10 shadow-sm">
                            {currentTab === 'SOBREPOSIÇÃO' ? (
                                <tr>
                                    ...
                                    <th className="border border-[#A00000] px-3 py-2.5 font-bold tracking-wider w-36 min-w-[144px]">Data Portin</th>
                                    <th className="border border-[#A00000] px-3 py-2.5 font-bold tracking-wider w-32 min-w-[128px]">Nº Portado</th>
                                    <th className="border border-[#A00000] px-3 py-2.5 font-bold tracking-wider w-32 min-w-[128px]">Nº Provisório</th>
                    ...
                    <div className="flex min-h-full items-center justify-center">
                        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl animate-fade-in">
                            <div className="p-6 border-b border-neutral-100 flex justify-between items-center bg-neutral-50 rounded-t-2xl">
                                <div><h2 className="text-xl font-bold text-neutral-800">Cadastro em Lote</h2><p className="text-sm text-neutral-500 mt-1">Insira os códigos para criar as linhas na seção <strong className="text-[#E3000F]">{currentTab}</strong>.</p></div>
