...
export const Venda = ({ salesData, setSalesData, isVendedor, globalUser, usersDB = {} }) => {
    ...
    const handleSubmitSale = (e) => {
        ...
        const finalMplay = isMovel ? mplay : 'NÃO';

        if (!vendedor || !data || !qtda || !produto || receita === '' || !cpf || (isMovel && (!portabilidade || !mplay))) { setFormError('Atenção: Você precisa preencher todas as informações obrigatórias para incluir a venda.'); return; }
